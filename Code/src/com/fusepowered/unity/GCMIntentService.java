...
public class GCMIntentService extends FuseGCMBaseIntentService
{
	 ...
	 */
	private void generateNotification(final Context context, final Intent m)
	{
		...
		handler.post(new Runnable()
		{
			...
			public void run()
			{
                ...
                // only display a push notification if there is a valid notification id included in the intent
				if( FuseAPI.notificationID != null )
				{
