...
//		super.onActivityResult(requestCode, resultCode, data);
	...
	public void uncaughtException(Thread thread, Throwable ex)
	{
		...
		FuseAPI.registerCrash(crashInfo, crashName, stack, System.currentTimeMillis());
	}
...
// +-----------------------+
	...
	public static void checkAdAvailable(final String _adZone)
	{
		_activity.runOnUiThread(new Runnable() {
		    public void run() {
				//Log.d(_logTag, "checkAdAvailable()");
		    	FuseAPI.checkAdAvailable(_adZone,_adCallback);
   		    }
		});
	}

	public static void showAd(final String _adZone)
	{
		...
		_activity.runOnUiThread(new Runnable() 
		{
		    public void run() 
		    {
		    	FuseAPI.displayAd( _adZone, _adCallback );
		    }
		});
	}

    public static void preloadAd(final String _adZone)
    {
        _activity.runOnUiThread(new Runnable()
        {
		    public void run()
		    {
		    	FuseAPI.preloadAdForZone( _adZone );
		    }
		});
