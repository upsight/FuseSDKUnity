...
public static class FusePostProcess
{
	...
	const string EVENTKITUI_ID = "3FBCE7861816DD570057C056";
	...
	const string EVENTKITUI_FW = "3FBCE7861816DD570057C057";
    ...
    public static void OnPostProcessBuild(BuildTarget target, string path)	
    {
        ...
        {			
			...
			Debug.Log("XcodeprojPath should be : "+xcodeprojPath);
    ...
    public static void updateXcodeProject(string xcodeprojPath, framework[] listeFrameworks)
    {
		...
		{
			Debug.LogError("Could not find Xcode project at the expected location.  You will need to manually add CoreTelephony, AdSupport, MessageUI, EventKit, EventKitUI, and StoreKit frameworks and the -ObjC linker flag");
			return;
		}		
