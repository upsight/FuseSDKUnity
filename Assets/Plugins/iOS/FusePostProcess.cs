...
public static class FusePostProcess
{
    ...
    public static void updateXcodeProject(string xcodeprojPath, framework[] listeFrameworks)
    {
		...
		{
			Debug.LogError("Could not find Xcode project at the expected location.  You will need to manually add CoreTelephony, AdSupport, MessageUI, EventKit, EventKitUI, Twitter, Social, and StoreKit frameworks and the -ObjC linker flag");
			return;
		}		
