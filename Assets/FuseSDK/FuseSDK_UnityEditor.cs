...
public partial class FuseSDK
{
	...
	{
		FuseDotNet.RegisterVirtualGoodsPurchase(virtualgoodID, currencyAmount, currencyID);
	}
	...
	public static void RegisterGender(Gender gender)
	{
		...
		FuseDotNet.RegisterGender((FuseSDKDotNETLite.Util.Gender)(int)gender);
	}
	...
	public static bool RegisterCurrency(int currencyType, int balance)
	{
		...
		return FuseDotNet.RegisterCurrency(currencyType, balance);
	}
	...
	public static void RegisterParentalConsent(bool consentGranted)
	{
		...
		FuseDotNet.RegisterParentalConsent(consentGranted);
	}
